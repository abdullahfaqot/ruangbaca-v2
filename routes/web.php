...
Route::middleware('guest')->group(function () {
    ...
    Route::get('register/kampus', [RegisterController::class, 'showFormKampus'])->name('register.kampus');
    Route::get('register/komunitas', [RegisterController::class, 'showFormKomunitas'])->name('register.komunitas');
    ...
    Route::post('register/komunitas/store', [RegisterController::class, 'registerKomunitas'])->name('register.komunitas.store');
