                ...
                <div class="card-search">
                    <div class="card-body-search p-xl-4">
                        ...
                        <div class="row pb-2 mb-4 border-bottom">
                            ...
                            <div class="col-7" style="padding: 0 7px;">
                            ...
                            <div class="col-3">
                                <a href="{{url('/detailbuku/'.$data->id.'/'.$data->slug)}}" class="btn btn-primary" style="margin-right: 5px;">Info</a>
                                <a href="{{url('/baca/'.$data->id.'/'.$data->slug)}}" class="btn btn-primary">Baca</a>
                            </div>
                        </div>
                        @empty
