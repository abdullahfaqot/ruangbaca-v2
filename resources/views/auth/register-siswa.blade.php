...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card p-3">
                <div class="card-body">
                    <h4 class="mb-3">Mendaftar sebagai Siswa/Mahasiswa</h4>
                    ...
                    <form class="row g-3" method="POST" action="{{route('register.siswa.store')}}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control @error('nisn') is-invalid @enderror" name="nisn" value="{{ old('nisn') }}" required placeholder="Masukkan NISN/NIM" autofocus>
