@extends('layouts.app')
@section('title','Mendaftar Sebagai Instansi')
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-8">
            <div class="card p-3">
                <div class="card-body">
                    <h4 class="mb-3">Mendaftar sebagai Instansi</h4>
                    ...
                    <form class="row g-3" method="POST" action="{{ route('register.sekolah.store') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('npsn') is-invalid @enderror" name="npsn" value="{{ old('npsn') }}" required placeholder="Masukkan NPSN Instansi" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" required placeholder="Masukkan Nama Instansi">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('jenjang') is-invalid @enderror" name="jenjang" required="">
                                ...
                                <option value="pt" @selected(old('jenjang')=='pt' )>Perguruan Tinggi</option>
                        ...
                        <div class="col-md-6" id="kotaField" @if(!$errors->has('kota')) style="display: none;" @endif>
                            <label class="form-label">Kabupaten/Kota Instansi</label>
                        ...
                        <div class="col-md-6" id="kelurahanField" @if(!$errors->has('kelurahan')) style="display: none;" @endif>
                            <label class="form-label">Kelurahan/Desa Instansi</label>
