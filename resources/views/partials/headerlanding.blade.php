                           ...
                           <div class="d-flex align-items-center position-relative mt-2">
                              ...
                              <div class="flex-grow-1 ms-2">
                                 ...
                                 <div class="progress progress-md">
                                    <div class="progress-bar" role="progressbar" style="width: 100px; border-radius: 0;" aria-label="Progress Membaca" aria-valuenow="{{round(($lastread->progress/$lastread->buku->jumlah_halaman)*100)}}" aria-valuemin="0" aria-valuemax="100"></div>
                                 </div>
                              </div>
                           </div>
                        </div>
